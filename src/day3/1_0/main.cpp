...
// シェーダファイル
static std::string VERT_SHADER_FILE1 = std::string(SHADER_DIRECTORY) + "render.vert" ;
static std::string FRAG_SHADER_FILE1 = std::string(SHADER_DIRECTORY) + "render.frag" ;
static std::string VERT_SHADER_FILE2= std::string(SHADER_DIRECTORY) + "back.vert";
static std::string FRAG_SHADER_FILE2 = std::string(SHADER_DIRECTORY) + "back.frag";
...
static const glm::vec3 top[3] = {
    glm::vec3(-1.0f, -1.0f, 1.0f),
    glm::vec3( 1.0f, 1.0f, 1.0f),
    glm::vec3(-1.0f,  1.0f, 1.0f),
};
static const glm::vec3 bottom[3] = {
    glm::vec3(-1.0f, -1.0f, 1.0f),
    glm::vec3( 1.0f, 1.0f, 1.0f),
    glm::vec3(1.0f,  -1.0f, 1.0f),
};
...
static const glm::vec3 colorsback[6] = {
...
struct GradationBackground {
    GradationBackground(const glm::vec3 &top,
...
// シェーダの初期化
void initShaders() {
    programId = buildShaderProgram(VERT_SHADER_FILE1, FRAG_SHADER_FILE1);
   // programId = buildShaderProgram(VERT_SHADER_FILE2, FRAG_SHADER_FILE2);
