...
static const char *WIN_TITLE = "OpenGL Course";     // ウインドウタイトルの追加
...
struct VertexArrayObject {
	...
	void draw() {
		...
		// Uniform変数の転送
		GLuint uid;
		uid = glGetUniformLocation(programId, "u_modelMat");
		glUniformMatrix4fv(uid, 1, GL_FALSE, glm::value_ptr(modelMat));
