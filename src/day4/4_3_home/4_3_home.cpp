...
static const char *WIN_TITLE = "OpenGL Course4-3";     // ウィンドウのタイトル
...
void initializeGL() {
    ...
    operate[0].initialize();
    operate[0].modelMat = glm::translate(operate[0].modelMat, glm::vec3(-2.0f, 0.0f, 0.0f));
    operate[1].initialize();
    operate[1].modelMat = glm::translate(operate[1].modelMat, glm::vec3(2.0f, 0.0f, 0.0f));
...
void updateMouse() {
    ...
    case ARCBALL_MODE_SCALE:
        operate[selectObject].acScale += (float)(oldPos.y - newPos.y) / WIN_HEIGHT;
