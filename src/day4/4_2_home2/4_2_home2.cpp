...
　 　　　//glUseProgram(programId);
        ...
        // GLuint LocId1 = glGetUniformLocation(programId, "u_mvpMat");
        // glUniformMatrix4fv(LocId1, 1, GL_FALSE, glm::value_ptr(mvpMat));
        ...
        glBindTexture(GL_TEXTURE_2D, textureId);
        // LocId1 = glGetUniformLocation(programId, "u_texture");
        // glUniform1i(LocId1, 0);
...
//         uid = glGetUniformLocation(programId, "u_selectID");
//         glUniform1i(uid, selectMode ? 2 : -1);
//         GLuint LocId2 = glGetUniformLocation(programId, "u_mvpMat");
//         glUniformMatrix4fv(LocId2, 1, GL_FALSE, glm::value_ptr(mvpMat));
...
//         glActiveTexture(GL_TEXTURE0);
//         glBindTexture(GL_TEXTURE_2D, textureId);
//         LocId2 = glGetUniformLocation(programId, "u_texture");
//         glUniform1i(LocId2, 0);
//         // 三角形の描画
//         glDrawElements(GL_TRIANGLES, 48, GL_UNSIGNED_INT, 0);
//     }
