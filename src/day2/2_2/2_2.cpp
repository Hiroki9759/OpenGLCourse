...
void drawTriangle(float r, float g, float b, float length){
    glBegin(GL_TRIANGLES);
    glColor3f(r, g, b);
    glVertex2f(0.0f - length/2, 0.0f);
    glVertex2f(0.0f + length/2, 0.0f);
...
void paintGL() {
    ...
    drawTriangle(1.0, 0.0, 0.0, 0.2);
    glPopMatrix();
    
    // 長針
    glPushMatrix();
    glRotatef(-2.0f * theta, 0.0f, 0.0f, 1.0f);
    glScalef(1.0f, 1.0f, 1.0f);
    
    drawTriangle(0.0, 1.0, 0.0, 0.1);
    glPopMatrix();
    
    // 秒針
    glPushMatrix();
    glRotatef(-4.0f * theta, 0.0f, 0.0f, 1.0f);
    glScalef(1.0f, 1.0f, 1.0f);
    
    drawTriangle(0.0, 0.0, 1.0, 0.05);
    glPopMatrix();
}
